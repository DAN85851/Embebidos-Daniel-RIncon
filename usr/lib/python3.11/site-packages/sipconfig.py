...
_pkg_config = {
    'android_abi':        '',
    'arch':               '',
    'default_bin_dir':    '/workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/bin',
    'default_mod_dir':    '/workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/lib/python3.11/site-packages',
    'default_sip_dir':    '/workspace/buildroot/output/per-package/python-sip/target/usr/share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/include/python3.11',
    'py_inc_dir':         '/workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/include/python3.11',
    'py_lib_dir':         '/workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/lib/python3.11/config',
    'py_version':         0x030b06,
    'qt_framework':       0,
    'sip_bin':            '/workspace/buildroot/output/per-package/python-sip/target/usr/bin/sip',
    'sip_config_args':    '--bindir /workspace/buildroot/output/per-package/python-sip/target/usr/bin --destdir /workspace/buildroot/output/per-package/python-sip/target/usr/lib/python3.11/site-packages --incdir /workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/include/python3.11 --sipdir /workspace/buildroot/output/per-package/python-sip/target/usr/share/sip --sysroot /workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr --no-stubs --use-qmake',
    'sip_inc_dir':        '/workspace/buildroot/output/per-package/python-sip/host/riscv64-buildroot-linux-musl/sysroot/usr/include/python3.11',
    'sip_module_dir':     '/workspace/buildroot/output/per-package/python-sip/target/usr/lib/python3.11/site-packages',
    'sip_root_dir':       '/workspace/buildroot/output/per-package/python-sip/target/usr/lib/python3.11/site-packages',
