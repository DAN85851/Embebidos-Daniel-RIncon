...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc '
              '-shared -mcpu=c906fdv -march=rv64imafdcv0p7xthead '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_LDFLAGS': '-mcpu=c906fdv -march=rv64imafdcv0p7xthead '
                      '-mcmodel=medany -mabi=lp64d',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--target=riscv64-buildroot-linux-musl' "
                "'--host=riscv64-buildroot-linux-musl' "
                ...
                "'--enable-shared' '--enable-lib2to3' '--disable-berkeleydb' "
                "'--with-libmpdec=none' '--with-expat=system' "
                "'--with-openssl=/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr' "
                "'--disable-uuid' '--disable-ossaudiodev' "
                "'--without-ensurepip' '--without-cxx-main' "
                "'--with-build-python=/workspace/buildroot/output/per-package/python3/host/bin/python3' "
                "'--with-system-ffi' '--disable-pydoc' "
                "'--disable-test-modules' '--disable-tk' '--disable-nis' "
                "'--disable-idle3' '--disable-pyc-build' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=riscv64-buildroot-linux-musl' "
                "'target_alias=riscv64-buildroot-linux-musl' "
                "'PKG_CONFIG=/workspace/buildroot/output/per-package/python3/host/bin/pkg-config' "
                "'CC=/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc' "
                "'CFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE "
                "-D_FILE_OFFSET_BITS=64  -O2 -g0 ' 'LDFLAGS=-mcpu=c906fdv "
                "-march=rv64imafdcv0p7xthead -mcmodel=medany -mabi=lp64d' "
                "'CPPFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE "
                "-D_FILE_OFFSET_BITS=64' "
                "'CPP=/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-cpp'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/workspace/buildroot/output/build/python3-3.11.6/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/workspace/buildroot/output/build/python3-3.11.6/lcov-report',
 ...
 'CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
             '-D_FILE_OFFSET_BITS=64',
 'CXX': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-g++',
 ...
 'DFLAGS': '',
 'DIRMODE': 755,
 'DISABLED_EXTENSIONS': '_decimal ossaudiodev nis _tkinter _uuid _dbm',
 ...
 'FREEZE_MODULE': '/workspace/buildroot/output/per-package/python3/host/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/workspace/buildroot/output/per-package/python3/host/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'riscv64-buildroot-linux-musl',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-g++ '
                '-shared',
 'LDFLAGS': '-mcpu=c906fdv -march=rv64imafdcv0p7xthead -mcmodel=medany '
            '-mabi=lp64d',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc '
             '-shared -mcpu=c906fdv -march=rv64imafdcv0p7xthead '
             '-mcmodel=medany -mabi=lp64d',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBS': '-ldl  -lpthread',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc',
 ...
 'MAINCC': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/bin/../riscv64-buildroot-linux-musl/sysroot/usr/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '',
 'MODULE_ZLIB_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/bin/../riscv64-buildroot-linux-musl/sysroot/usr/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '',
 'MODULE__LZMA_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/bin/../riscv64-buildroot-linux-musl/sysroot/usr/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/bin/../riscv64-buildroot-linux-musl/sysroot/usr/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr/lib  '
                        '-lssl -lcrypto',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr/include',
 'OPENSSL_LDFLAGS': '-L/workspace/buildroot/output/per-package/python3/host/riscv64-buildroot-linux-musl/sysroot/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/workspace/buildroot/output/build/python3-3.11.6 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/workspace/buildroot/output/build/python3-3.11.6/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_riscv64-linux-gnu '
                     '/workspace/buildroot/output/per-package/python3/host/bin/python3',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/workspace/buildroot/output/per-package/python3/host/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall -D_LARGEFILE_SOURCE '
                   ...
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-mcpu=c906fdv -march=rv64imafdcv0p7xthead -mcmodel=medany '
                    '-mabi=lp64d',
 'PY_CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
                '-D_FILE_OFFSET_BITS=64',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-mcpu=c906fdv -march=rv64imafdcv0p7xthead -mcmodel=medany '
               '-mabi=lp64d',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-mcpu=c906fdv -march=rv64imafdcv0p7xthead '
                     '-mcmodel=medany -mabi=lp64d',
 ...
 'READELF': '/workspace/buildroot/output/per-package/python3/host/bin/riscv64-unknown-linux-musl-readelf',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/workspace/buildroot/output/build/python3-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/workspace/buildroot/output/build/python3-3.11.6/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/workspace/buildroot/output/per-package/python3/host/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/workspace/buildroot/output/build/python3-3.11.6 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/workspace/buildroot/output/build/python3-3.11.6/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/workspace/buildroot/output/build/python3-3.11.6',
 'abs_srcdir': '/workspace/buildroot/output/build/python3-3.11.6',
